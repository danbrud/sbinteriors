...
class ExpensesController {
    constructor() {
        ...
        this.getExpensesByClientId = async (req, res) => {
            ...
            const projects = await this.expensesService.getExpensesByProjectId(projectId);
            res.send(projects);
        };
    ...
    intializeRoutes() {
        ...
        this.router.get('/:projectId', this.getExpensesByClientId);
        this.router.post('/', this.createExpense);
    }
}
exports.ExpensesController = ExpensesController;
//# sourceMappingURL=expenses.controller copy.js.map