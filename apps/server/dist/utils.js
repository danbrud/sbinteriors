...
exports.generateHtml = exports.createPDF = exports.validateLoginInput = exports.getTotal = void 0;
...
exports.createPDF = function (document, options) {
    return new Promise((resolve, reject) => {
        ...
        // Compiles a template
        const html = exports.generateHtml(document.html, document.data);
...
exports.generateHtml = (template, data) => {
    const html = handlebars_1.default.compile(template)(data, {
